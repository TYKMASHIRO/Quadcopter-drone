...
#include "spi.h"
#include "stdio.h"
#define NRF24L01_CSN_HIGH HAL_GPIO_WritePin(SPI2_NSS_GPIO_Port, SPI2_NSS_Pin, GPIO_PIN_SET)
#define NRF24L01_CSN_LOW HAL_GPIO_WritePin(SPI2_NSS_GPIO_Port, SPI2_NSS_Pin, GPIO_PIN_RESET)
